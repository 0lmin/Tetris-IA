...
for i in range(1, 11):
    for j in range(1, 21):
        pygame.draw.circle(screen, SECONDARY_COLOR, (int(BOARD_LEFT - DOT_SPACE_WIDTH / 2 + i * DOT_SPACE_WIDTH), int(BOARD_TOP - DOT_SPACE_HEIGHT / 2 + j * DOT_SPACE_HEIGHT)), DOT_RADIUS)
